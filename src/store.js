...
export const useStore = create((set) => ({
  // null = overview; otherwise 'laptop' | 'phone' | 'resume' | 'book' | 'clock' | 'plant'
  focus: null,
  hovered: null,
...
export const LAYOUT = {
  ...
  resume: { pos: [-0.56, DESK_Y, 0.13], rot: 0.14 },
  book: { pos: [0.64, DESK_Y, 0.11], rot: -0.28 },
...
export const SHOTS = {
  ...
  resume: [[-0.545, 1.22, 0.25], [-0.56, 0.77, 0.13]],
  book: [[0.52, 1.24, 0.46], [0.56, 0.77, 0.08]],
